...
// Mount API routes
const { default: router_0 } = await import('../api/campaigns/route.js');
app.route('/api/campaigns', router_0);
const { default: router_1 } = await import('../api/index.js');
app.route('/api', router_1);
